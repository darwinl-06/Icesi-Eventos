        ...
        <div className=''>
            ...
            <div className='flex-grow p-4 pt-28'>
                ...
                <h1 className="text-2xl font-semibold text-center mb-10">
                    Eventos a los que estoy inscrito
                </h1>
                        ...
                        {filterData.map(evento => (
                            ...
                            >
                                ...
                                <div className="lg:w-2/3 lg:pl-8 mt-4 lg:mt-0">
                                    <h2 className="text-black text-xs tracking-widest title-font mb-5">{evento.fecha}</h2>
                                    <h2 className="text-black title-font text-2xl font-medium hover:text-hover-orange">{evento.titulo}</h2>
