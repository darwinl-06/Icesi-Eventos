    ...
    return (
        <div className="flex min-h-screen">
            ...
            <div className="flex-grow p-4 pt-28">
                ...
                <Link to='/Events' className="text-white bg-blue-900 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 fixed right-0 bottom-0 mb-10 mr-10">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {participantes.map((participante, index) => (
                                <tr key={index}>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">{participante.usuario.tipoRelacion}</td>
                                    <td className="px-6 py-4 whitespace-nowrap">{participante.usuario.ciudad.nombre}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
